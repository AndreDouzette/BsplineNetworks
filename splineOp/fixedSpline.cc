...
class FixedBSplineOp: public OpKernel{
	public:
	explicit FixedBSplineOp(OpKernelConstruction* context): OpKernel(context){}
...
REGISTER_KERNEL_BUILDER(Name("FixedBSpline").Device(DEVICE_CPU), FixedBSplineOp);
